...
export default function Page() {
  ...
  const businessName = "Big Al's Landscaping";
  const serviceType = "Landscaping";
  const serviceDescription = "Full Landscaping Design and Installation\nMowing\nTree and Bush Trimming\n";
  const serviceAreas = "Austin, Dallas, Fort Worth, Houston";
  const phoneNumber = "999-999-9999";
  const email = "me@landscaping.com";
  const logo = "https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/logo-1761314668329-1ixvkq.png";
  const differentiation2 = "Great Personality";
  const differentiation3 = "Stays Until Finished";
  const headerFooterColor = "#483e0f";
  const backgroundColor = "#f0fdf4";
  const accentColor = "#e6d837";

  const portfolioPhotos: Array<{name: string; type: string; url: string}> = [{"name":"download (1).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314951077-5l7e4p.jpg"},{"name":"download (2).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314951388-d4ajmt.jpg"},{"name":"download (3).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314951608-nmni5.jpg"},{"name":"download (4).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314951835-6azmim.jpg"},{"name":"download (5).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314952064-iwhmtm.jpg"},{"name":"download (6).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314952351-2chsok.jpg"},{"name":"download (8).jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314952609-gjvzm7.jpg"},{"name":"download.jpg","type":"image/jpeg","url":"https://qsaefjpdhmcwuiytcvan.supabase.co/storage/v1/object/public/portfolio-photos/landing-page/1761314952768-fdqjdb.jpg"}];
